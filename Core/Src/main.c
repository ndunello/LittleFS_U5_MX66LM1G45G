...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
  printf("LittleFS STM32U5G9J-DK2 MX66LM1G45G rev 1.0\r\n");
  littlefs_test(MX66UW1G45G_TEST_SPI_MODE);
//  littlefs_test(MX66UW1G45G_TEST_OPI_STR_MODE);
//  littlefs_test(MX66UW1G45G_TEST_OPI_DTR_MODE);
  /* USER CODE END 2 */
